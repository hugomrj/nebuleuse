...
public final  class Serializacion {    
        ...
        private ArrayList <Enlace> elementos = new ArrayList <Enlace>()  {
            { 
                add(new Enlace());  
                add(new Enlace());
            }
        ...
        public void generar( Object objeto)  {
            ...
            try 
            {
                ...
                File fileXML = new File(this.ruta+objeto.getClass().getSimpleName()+".xml");
        ...
        for ( int i = 0; i < hijos.getLength(); i++ )
        {
            ...
            { 
                ...
                if ((isElemento == true))
                {
                    ...
                    Enlace nvoEnlace = new Enlace(elemento.getTabla(), elemento.getObjeto() );
    ...
    public ArrayList <Enlace> getElementos() {
        return elementos;
    }

    public void setElementos(ArrayList <Enlace> elementos) {
